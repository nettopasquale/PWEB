  ...
  return (
    ...
    <section className="flex flex-col items-center justify-start px-4 py-12 space-y-24">
        ...
        <Cards titulo={
          ...
          botaoTexto="Buscar" imagem={card1} to='/buscar'/>
        ...
        <Cards titulo={
          ...
          descricao={
          <> 
            Mantenha a sua comunidade atualizada <br />
            e ajude a manter este projeto ativo.
          </>
          }
          botaoTexto="Cadastrar" imagem={card2} reverse to="/cadastrar"/>
        ...
        <Cards titulo={
          ...
          botaoTexto="Listar" imagem={card3} to="/listar" />
    </section>
    </PageLayout>
  );
}
