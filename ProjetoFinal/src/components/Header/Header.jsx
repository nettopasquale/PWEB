    ...
    <header className="w-full bg-black border-b border-gray-700 p-6">
        ...
        <div className="hidden md:flex items-center gap-6">
          <nav className="flex gap-4 text-white text-base font-medium">
            ...
            <a href="#sobre" className="hover:text-red-500 text-2xl transition">Sobre Nós</a>
            <a href="#contato" className="hover:text-red-500 text-2xl transition">Contato</a>
          </nav>
      ...
      {isMenuOpen && (
        <div className="mt-4 md:hidden flex flex-col gap-4 text-white text-base font-medium">
          <nav className="flex flex-col gap-2">
            <a href="#favoritos" className="hover:text-red-500 transition">Meus Favoritos</a>
            <a href="#filmes" className="hover:text-red-500 transition">Filmes</a>
            <a href="#series" className="hover:text-red-500 transition">Séries</a>
